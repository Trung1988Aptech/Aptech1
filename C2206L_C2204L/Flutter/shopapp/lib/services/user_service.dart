...
import 'package:foodapp/dtos/requests/user/SocialLoginRequest.dart';
...
class UserService extends BaseService {
  ...
  Future<ApiResponse> loginSocial(SocialLoginRequest socialLoginRequest) async {
    final String apiUrl = '${APIConstants.baseUrl}/users/login'; // Adjusted endpoint for social login
    final response = await request(
      apiUrl: apiUrl,
      method: HttpMethod.POST,
      requestData: socialLoginRequest.toJson(),
    );
